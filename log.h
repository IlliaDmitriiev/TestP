...
public:
    /*
     * overloaded operator() which changes log level
     * in the current instance
     */
    log& operator() (LogLevel log_level);

    /*
     * overloaded operator<< which prints
     * message to file or console
     *
     * @return instance of Writer which prints
     * following massages to file or console
     *
     * @note: when the instance of Writer is destroyed
     * it means the end of message
     */
    template<typename T>
    Writer operator<<( T s){
